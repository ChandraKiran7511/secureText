...
-----------------------------------------------------------
'''
@application.route('/public-key-directory/retrieve/key/<username>')
...
@application.route('/file-directory/retrieve/file/<filename>')
...
@application.route('/public-key-directory/')
def downloads_pk():
	username = []
...
@application.route('/file-directory/')
def download_f():
...
-----------------------------------------------------------
'''
@application.route('/register-new-user', methods = ['GET', 'POST'])
def register_user():
	files = []
	privatekeylist = []
	usernamelist = []
